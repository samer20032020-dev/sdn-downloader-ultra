...
RELEASE_BODY  = (
    ...
    "- ✂️ ميزة اقتطاع جزء من الفيديو: تحديد دقائق وثواني البداية والنهاية لتنزيل الأجزاء المطلوبة فقط مباشرة من السيرفر بدون تحميل كامل الفيديو\n"
    "- 🔄 تحديث Windows صامت بالكامل: يغلق البرنامج، يستبدل نفسه في المجلد نفسه، ثم يعيد التشغيل تلقائياً من دون معالج تثبيت أو نافذة لغة\n"
    "- 🛡️ تنزيل النسخة المحمولة الموثقة مباشرة والتحقق من اسم أصل GitHub والحجم وبصمة SHA-256 قبل تطبيق التحديث، مع مُثبت صامت احتياطي للمجلدات المحمية\n"
    "- 🗑️ نافذة حذف عربية عصرية ومتجاوبة بدل نافذة المتصفح القديمة، مع فصل واضح بين الإزالة من القائمة والحذف النهائي من الجهاز\n"
    "- 🛡️ زر التراجع لا يحذف شيئاً، ودعم الإغلاق بزر Escape والنقر خارج النافذة مع عرض مرتب لأسماء الأغاني الطويلة\n"
    "- 🎵 تحويل تلقائي مخبأ لملفات M4A/FLAC/OGG/OPUS/WMA إلى نسخة MP3 متوافقة مع مشغّل Windows من دون تعديل الملف الأصلي\n"
    "- 🧭 إعادة ضبط وقت وشريط تقدم المشغّل عند تغيير الأغنية مع تشخيص أدق لأخطاء WebView2\n"
    "- 🔊 إصلاح تشغيل الصوت داخل Windows عبر بث محلي آمن يدعم التقديم والتأخير\n"
    "- 📚 إصلاح تنزيل قائمة YouTube كاملة وتحويل روابط الفيديو الموجودة داخل قائمة تلقائياً\n"
