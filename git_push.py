...
BRANCH        = "main"
RELEASE_TAG   = "v0.6.0"
RELEASE_NAME  = "SDN v0.6.0"
RELEASE_BODY  = (
    "## ⚡ SDN v0.6.0 — حظر وتفادي تكرار فتح نافذة التثبيت\n\n"
    "### ✨ الميزات والإصلاحات الجديدة:\n"
    "- 🛑 منع تكرار فتح نافذة المثبت (Single Instance Protection) لتفتح النافذة مرة واحدة فقط\n"
    "- 🚀 إضافة زر اختبار سرعة المحرك الذكي لتجربة سرعة الاتصال بالسيرفرات\n"
