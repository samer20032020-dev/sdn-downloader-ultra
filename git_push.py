...
BRANCH        = "main"
RELEASE_TAG   = "v0.1.0"
RELEASE_NAME  = "SDN v0.1.0"
RELEASE_BODY  = (
    "## ⚡ SDN v0.1.0 — الإصدار الأولي البسيط\n\n"
    "### ✨ المميزات والتحديثات:\n"
    "- 🚀 الإصدار الأولي الرسمي للبرنامج (SDN v0.1.0)\n"
    "- ⚡ التحميل الفائق والمباشر بجميع الجودات للصوت والفيديو\n"
    "- 🎯 واجهة مستخدم متطورة وسريعة جداً مع التحديث التلقائي الصامت\n"
)
