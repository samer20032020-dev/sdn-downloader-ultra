...
BRANCH        = "main"
RELEASE_TAG   = "v0.5.0"
RELEASE_NAME  = "SDN v0.5.0"
RELEASE_BODY  = (
    "## ⚡ SDN v0.5.0 — اختبار التحديث السريع ومحرك السرعة الذكي\n\n"
    "### ✨ الميزات والإصلاحات الجديدة:\n"
    "- 🚀 إضافة زر اختبار سرعة المحرك الذكي v0.5.0 لتجربة سرعة الاتصال بالسيرفرات\n"
    "- 🔄 تحسين وتأكيد عمل نظام التحديث التلقائي الفوري داخل التطبيق\n"
